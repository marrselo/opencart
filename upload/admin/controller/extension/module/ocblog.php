...
class ControllerExtensionModuleOcblog extends Controller
{
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->model_setting_setting->editSettingValue('ocblog', 'ocblog_article_limit', $this->request->post['ocblog_article_limit']);
            $this->model_setting_setting->editSettingValue('ocblog', 'ocblog_meta_title', $this->request->post['ocblog_meta_title']);
            $this->model_setting_setting->editSettingValue('ocblog', 'ocblog_meta_description', $this->request->post['ocblog_meta_description']);
            $this->model_setting_setting->editSettingValue('ocblog', 'ocblog_meta_keyword', $this->request->post['ocblog_meta_keyword']);
