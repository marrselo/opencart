          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-4 col-sm-12">
				<table id="module-content-block" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block2" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block2; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block2');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block3" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block3; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block3');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block4" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block4; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block4');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block5" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block5; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block5');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-banner" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_banner; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-banner');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
			  ...
			  <table id="module-content-block6" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block6; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block6');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block7" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block7; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block7');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
                </table>
				<table id="module-content-block8" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block8; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block8');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block9" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block9; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block9');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-block, #module-content-block2, #module-content-block3, #module-content-block4, #module-content-block5, #module-content-block6, #module-content-block7, #module-content-block8, #module-content-block9, #module-content-banner').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-block, #module-content-block2, #module-content-block3, #module-content-block4, #module-content-block5, #module-content-block6, #module-content-block7, #module-content-block8, #module-content-block9, #module-content-banner').trigger('change');
//--></script>
</div>
<?php echo $footer; ?>