			...
			<div class="f-col f-col-1 col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="100ms">
				...
				<div class="toggle-footer">
					<ul class="footer-content-contact">
						<li><span class="fa fa-circle"></span><span><?php echo $text_fax; ?></span> <span class="contact-content"><?php echo $fax; ?></span></li>
						<li><span class="fa fa-circle"></span><span><?php echo $text_telephone; ?></span> <span class="contact-content"><?php echo $telephone; ?></span></li>
						<li><span class="fa fa-circle"></span><span><?php echo $text_email; ?></span> <span class="contact-content"><?php echo $email; ?></span></li>
					</ul>
