...
<div class="footer-top">
	<div class="container">
		<div class="row">
			<div class="f-col f-col-1 col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="100ms">
			...
			<div class="f-col f-col-2 col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="100ms">
				<?php echo $content_block8; ?>
			</div>
			<div class="f-col f-col-3 col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="100ms">
				<div class="footer-title2"><h3><?php echo $text_follow_title; ?></h3></div>
...
<div class="footer">
	<div class="container">
		<div class="row">
			<div class="column col5 col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="100ms">
				<a href="#"><img alt="" src="image/catalog/banner_footer.jpg"></a>
			</div>
