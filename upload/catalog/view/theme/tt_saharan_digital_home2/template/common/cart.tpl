<div id="cart" class="btn-group btn-block">
	<button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle text_exist">
		<span id="cart-total"><span class="cart-total-title"><?php echo $text_items_title; ?></span> (<?php echo $text_items; ?>)</span>
	</button>
